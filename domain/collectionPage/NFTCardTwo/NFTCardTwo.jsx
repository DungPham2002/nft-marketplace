        ...
        {NFTData?.map((el, i) => (
            <Link href={{ pathname:"/NFT-details", query:  { ...el, endTime: el.endTime?.toString() } }} key={i + 1}>
                ...
                <div className="flex justify-between items-end p-[1rem]">
                    ...
                    <p className="rounded-[0.3rem] text-[1.1rem] pt-[1rem] px-[1.5rem] pb-[0.5rem] border-[1px] border-solid border-icons-color">{el.price ? (el.price.slice(0,5)) : (el.minBid) ? (el.minBid.slice(0,5)) : 0} ETH</p>
                    </div>
